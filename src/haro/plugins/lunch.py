...
KML_SOURCE = 'https://www.google.com/maps/d/u/0/kml?hl=en&mid=1J4U-QXOe1Zi_4Lw5UxaL8AriG6M&lid=zubJL41y6fLI.k8KrINTXzJI4&forcekml=1'
MAPS_URL_BASE = 'http://maps.google.com/maps/ms?ie=UTF&msa=0&msid=101243938118389113627.00047d5491d28f02d4f57&z=19&iwloc=A&ll='
...
def get_distance_from_office(destination):
    ...
    destination_coordinates = (destination['geometry']['coordinates'][1], destination['geometry']['coordinates'][0])
